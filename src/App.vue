	...
	data() {
		return {
			...
			notes: localStorage.notes ?  JSON.parse(localStorage.notes) : [
				{id:1, title: 'Список дел на вчера',
				tasks: [
				...
				{id:2, title: 'Список дел на сегодня', 
				tasks: [
				...
				{id:3, title: 'Список дел на завтра', 
				tasks: [
					{id:1, title: 'Дело №1', isComplete: true},
					{id:2, title: 'Дело №2', isComplete: false},
					{id:3, title: 'Дело №3', isComplete: false}
				]},
				{id:4, title: 'Список дел на следующую неделю', 
				tasks: [
					{id:1, title: 'Дело №1', isComplete: true},
					{id:2, title: 'Дело №2', isComplete: false},
					{id:3, title: 'Дело №3', isComplete: false},
				...
				{id:5, title: 'Список дел на ближайшие пять лет', 
				tasks: [
					{id:1, title: 'Дело №1', isComplete: true},
					{id:2, title: 'Дело №2', isComplete: false},
					{id:3, title: 'Дело №3', isComplete: false},
...
@font-face {
	...
	font-style: normal;
	font-weight: normal;
	src: local('Kwixter Sketch'), url('/fonts/Kwixter Sketch_D.woff') format('woff');
}
html, body {
	width: 100%;
	margin: 0;
...
#app {
	...
	/* font-family: 'Kwixter Sketch', serif !important; */
